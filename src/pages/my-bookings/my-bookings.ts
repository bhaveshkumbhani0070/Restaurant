...
export class MyBookingsPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public auth: AuthProvider, public home: HomeServiceProvider, private loadingCtrl: LoadingController ,  private popoverCtrl: PopoverController ) {
  }
