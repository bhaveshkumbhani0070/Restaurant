...
export class PromotionPage {
  ...
  constructor(private toastCtrl: ToastController, private loadingCtrl: LoadingController ,  private promo: PromotionProvider, private popoverCtrl: PopoverController ) {
    this.getPromotions();
  }
